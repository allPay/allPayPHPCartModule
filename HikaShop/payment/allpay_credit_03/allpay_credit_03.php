<?php
	...
	class plgHikashoppaymentallpay_credit_03 extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_credit_03';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶]信用卡(3期)';
            $element->payment_description = '您可透過此付款方式進行信用卡(3期)付款';
