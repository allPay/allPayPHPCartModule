<?php
	...
	class plgHikashoppaymentallpay_webatm extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_webatm';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶]Web-ATM';
            $element->payment_description = '您可透過此付款方式進行Web-ATM付款';
