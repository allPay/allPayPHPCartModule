<?php
	...
	class plgHikashoppaymentallpay_credit_06 extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_credit_06';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶]信用卡(6期)';
            $element->payment_description = '您可透過此付款方式進行信用卡(6期)付款';
