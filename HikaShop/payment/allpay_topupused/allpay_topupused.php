<?php
	...
	class plgHikashoppaymentallpay_topupused extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_topupused';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶]儲值/餘額消費';
            $element->payment_description = '您可透過此付款方式進行儲值/餘額消費付款';
