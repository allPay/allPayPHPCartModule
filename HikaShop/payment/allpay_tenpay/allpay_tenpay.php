<?php
	...
	class plgHikashoppaymentallpay_tenpay extends hikashopPaymentPlugin {
		var $accepted_currencies = array('TWD');
        
		var $multiple = true;
		var $name = 'allpay_tenpay';
        ...
        function getPaymentDefaultValues(&$element) {
            $element->payment_name = '[歐付寶]財付通';
            $element->payment_description = '您可透過此付款方式進行財付通付款';
