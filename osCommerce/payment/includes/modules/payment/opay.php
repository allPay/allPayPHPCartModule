...
class opay
{
    ...
    function after_process()
    {
        ...
        try
        {
            # Load O'Pay integration module
            require(DIR_FS_CATALOG . 'ext/modules/payment/opay/AllPay.Payment.Integration.php');
            ...
            $aio->Send['ReturnURL'] = tep_href_link('ext/modules/payment/opay/response.php', '', 'SSL');
    ...
    function get_allpay_config()
    {
        ...
        {
            global $language;
            include(DIR_FS_CATALOG_LANGUAGES . $language . '/modules/payment/opay.php');
        }
