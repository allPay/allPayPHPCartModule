<?php
	...
	*/
	...
	# Module description
	define('MODULE_PAYMENT_ALLPAY_TITLE_TEXT', 'O\'Pay');
	define('MODULE_PAYMENT_ALLPAY_DESC_TEXT', 'O\'Pay all in one payment');
	
	# Configurations description
	define('MODULE_PAYMENT_ALLPAY_REQUIRE_FIELD_TEXT', 'Required field');
	define('MODULE_PAYMENT_ALLPAY_ENABLE_TEXT', 'Enable O\'Pay Payment');
	...
	define('MODULE_PAYMENT_ALLPAY_PAYMENT_ZONE_TEXT', 'O\'Pay Payment Zone');
	define('MODULE_PAYMENT_ALLPAY_PAYMENT_ZONE_DESC_TEXT', 'If a zone is selected, only enable O\'Pay payment for that zone');
