<?php
class ModelPaymentallpayinvoice extends Model {
	...
	{
		$sFile_Name =  dirname(dirname(dirname(dirname(__FILE__)))) . DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'controller'.DIRECTORY_SEPARATOR.'payment'.DIRECTORY_SEPARATOR.'AllPay_Invoice.php' ;
