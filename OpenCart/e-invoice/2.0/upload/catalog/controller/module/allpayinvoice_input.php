...
?>
	...
	$("#button-payment-method").click(function(){
		...
		else
		{
			...
			$.ajax({
				type: 'POST',
				url: 'http://<?=$_SERVER['HTTP_HOST']?><?=$_SERVER['PHP_SELF']?>/index.php?route=payment/allpayinvoice/set_invoice_info',
				dataType: 'html',
...
<script type="text/javascript">
	...
	$( document ).ready(function() {
		...
		$.ajax({
			type: 'POST',
			url: 'http://<?=$_SERVER['HTTP_HOST']?><?=$_SERVER['PHP_SELF']?>/index.php?route=payment/allpayinvoice/del_invoice_info',
			dataType: 'html',
