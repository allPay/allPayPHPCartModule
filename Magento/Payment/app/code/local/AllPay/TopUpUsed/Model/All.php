...
class AllPay_TopUpUsed_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/topupused/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('topupused/processing/redirect');
		return $szActionUrl;
    }
