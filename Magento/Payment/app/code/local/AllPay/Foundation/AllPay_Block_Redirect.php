...
class AllPay_Block_Redirect extends Mage_Core_Block_Template {
    ...
    protected function AutoSubmit() {
        ...
        if ($order) {
            try {
                ...
                $oPayment->ServiceURL = ($this->_getConfigData('test_mode') ? 'https://payment-stage.allpay.com.tw/Cashier/AioCheckOut' : 'https://payment.allpay.com.tw/Cashier/AioCheckOut');
                ...
                $oPayment->Send['TradeDesc'] = 'allpay_magento_module_1.2.0321';
