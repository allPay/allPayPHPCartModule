...
class AllPay_Tenpay_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/tenpay/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('tenpay/processing/redirect');
		return $szActionUrl;
    }
